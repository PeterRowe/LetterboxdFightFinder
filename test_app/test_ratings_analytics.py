...
def test_get_biggest_differences_in_ratings():
    ...
    ratings = letterboxd_scraper.get_user_and_followers_reviews(username='prowe')
    ratings_analytics = RatingsAnalytics(ratings_dataframe=ratings)
    test = ratings_analytics.get_differences_in_ratings()